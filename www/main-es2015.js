...
const routes = [
    ...
    { path: 'layout', component: _containers_layout_layout_component__WEBPACK_IMPORTED_MODULE_3__["LayoutComponent"], children: [
            ...
            { path: 'streetfighter', loadChildren: () => __webpack_require__.e(/*! import() | streetfighter-street-fighter-module */ "streetfighter-street-fighter-module").then(__webpack_require__.bind(null, /*! ../streetfighter/street-fighter.module */ "./src/app/streetfighter/street-fighter.module.ts")).then(mod => mod.StreetFighterModule) }
        ] }
];
